...
<body>
    ...
    <section class="eight-img" id="sambutan">
    ...
    <p uk-margin>
      <button class="uk-button uk-button-default uk-button-large info5 mt-4">ANAN</button>
    </p>
    ...
    <div class="row">
      ...
      <div class="col-6">
        ...
        <p uk-margin>
          <button class="uk-button uk-button-default uk-button-large info5 mt-4">TINAN</button>
        </p>
        ...
        <p uk-margin>
          <button class="uk-button uk-button-default uk-button-large info5 mt-4">GANAN</button>
        </p>
