...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
   ...
   <body> 
    <section class="seven-img" id="sambutan">
      <div id="nav-page">
    ...
    <p uk-margin>
        <button class="uk-button uk-button-default uk-button-large info">Anthem Player</button>
    </p>

    <div class="uk-child-width-expand@s uk-text-center" uk-grid style="margin:10px 50px">
        <div>
            <div class="uk-card uk-card-default uk-card-body" style="margin:2px 300px">
                <video src="https://yootheme.com/site/images/media/yootheme-pro.mp4" width="1200" height="700" loop muted playsinline uk-video="autoplay: inview"></video>
            </div>
        </div>
    </div>
    </section>
