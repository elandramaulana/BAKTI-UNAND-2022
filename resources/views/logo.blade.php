...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
   ...
   <body> 
    <section class="five-img" id="sambutan">
      <div id="nav-page">
    ...
    <div class="uk-column mt-3" style="margin-left:8%">
        <img class="uk-button " href="#modal-center" uk-toggle src="image/logoB.png" width="200px" height="200px" alt="">
        ...
        <img class="uk-button " href="#modal-center1" uk-toggle src="image/logoC.png" width="200px" height="200px" alt="">
        ...
        <img class="uk-button " href="#modal-center2" uk-toggle src="image/logoD.png" width="200px" height="200px" alt="">
        ...
        <img class="uk-button " href="#modal-center3" uk-toggle src="image/logoE.png" width="200px" height="200px" alt="">
        ...
        <img class="uk-button " href="#modal-center4" uk-toggle src="image/logoF.png" width="200px" height="200px" alt="">
