...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body> 
    ...
    <section class="four-img" id="sambutan" style="background-color: #d1cacf;">
      <nav class="navbar navbar-expand-lg" style="background-color: #d1cacf;">
        <div class="container-fluid" style="background-color: #d1cacf;">
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon" style="background-color: #d1cacf;"></span>
          </button>
          <div class="collapse navbar-collapse" id="navbarNav" style="background-color: #d1cacf;">
